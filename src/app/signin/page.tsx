  ...
  return (
    <div className='w-full h-screen relative' >
      ...
      <div className='absolute top-0 left-0 p-4 w-full h-full' >
        ...
        <div className='mx-auto mt-6 w-[400px] rounded-md max-[450px]:w-[300px] bg-black/80 space-y-8 text-white max-[450px]:px-8 max-[350px]:w-[250px] max-[350px]:px-4 px-12 py-10' >
          ...
          <form className='space-y-4' onSubmit={handleSubmit((data) => handleOnSubmit(data))} >
            ...
            <div  >
              <button className='py-2 w-full mt-4 rounded-md bg-primary font-semibold' >Sign In</button>
          ...
          <div>
            <p className=' text-base font-normal text-gray-500' >New to Netflix? <Link href={"/signup"} >Sign up now.</Link></p>
          </div>
        </div>
      </div>
    </div>
